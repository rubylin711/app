    ...
    private static class Receiver extends BroadcastReceiver {
        ...
        public void startListening(Listener listener, List<BluetoothDeviceCriteria> matchers) {
            ...
            synchronized (mListenerLock) {
                for (int ptr = mClients.size() - 1; ptr > -1; ptr--) {
                    Log.d(TAG, "startListening listener = " + listener + " mClients.get(ptr).listener = " + mClients.get(ptr).listener);
            ...
            Log.d(TAG, "startListening mClients.size() = " + mClients.size() ) ;
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothDevice.ACTION_FOUND.equals(action)) {
                ...
                if (DEBUG) {
                    Log.d(TAG, "Device found, address: " + address + " name: \"" + name + "\""+ " rssi: \"" + rssi + "\"");
                }
