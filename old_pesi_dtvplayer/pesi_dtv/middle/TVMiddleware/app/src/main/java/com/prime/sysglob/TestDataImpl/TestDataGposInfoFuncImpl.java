...
import com.prime.sysglob.GposInfoFunc;
...
public class TestDataGposInfoFuncImpl implements GposInfoFunc
{
    ...
    public GposInfo GetGposInfo() {
        ...
        Gpos.setAudioStereo(curGPos.getAudioStereo());
        Gpos.setPalStandard(curGPos.getPalStandard());
        Gpos.setMonitorType(curGPos.getMonitorType());
        ...
        Gpos.setStandbyMode(curGPos.getStandbyMode());
        ...
        Gpos.setGoBackStandby(curGPos.getGoBackStandby());
    ...
    public void Save(GposInfo Gpos) {
        ...
        curGPos.setAudioStereo(Gpos.getAudioStereo());
        curGPos.setPalStandard(Gpos.getPalStandard());
        curGPos.setMonitorType(Gpos.getMonitorType());
        ...
        curGPos.setStandbyMode(Gpos.getStandbyMode());
        ...
        curGPos.setGoBackStandby(Gpos.getGoBackStandby());
