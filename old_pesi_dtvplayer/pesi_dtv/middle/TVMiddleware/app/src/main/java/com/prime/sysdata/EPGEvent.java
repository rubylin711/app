...
public class EPGEvent {
    ...
    private long StartTimeUtcM;
    private long StartTimeUtcL;
    ...
    public String ToString(){
        return "[Sid  " + Sid + "OriginalNetworkId : " + OriginalNetworkId + "TransportStreamId : " + TransportStreamId
                ...
                + "StartTimeUtcM : " + StartTimeUtcM + "StartTimeUtcL : "+ StartTimeUtcL + "Duration : "+ Duration + "ParentalRate : "
    ...
    public long getStartTimeUtcM() {
        return StartTimeUtcM;
    }

    public void setStartTimeUtcM(long startTimeUtcM) {
        StartTimeUtcM = startTimeUtcM;
    }
    ...
    public long getStartTimeUtcL() {
        return StartTimeUtcL;
    }

    public void setStartTimeUtcL(long startTimeUtcL) {
        StartTimeUtcL = startTimeUtcL;
    }
