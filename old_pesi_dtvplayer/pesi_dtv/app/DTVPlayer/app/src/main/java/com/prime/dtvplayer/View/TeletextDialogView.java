...
public class TeletextDialogView extends Dialog{
    ...
    public TeletextDialogView(Context context, DTVActivity dtv, int playid)
    {
...
//        setCancelable(false);// disable click back button // Johnny 20181210 for keyboard control
        ...
        setContentView(R.layout.txt_dialog_view);
