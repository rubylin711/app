...
public class HDCP1xActivity extends DTVActivity {
    private static final String TAG = "HDCP1xActivity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hdcp1x);
    ...
    public void onBackPressed() {
        ...
        if (mHDCPSuccess) {
            pesiSharedPreference.putInt(getResources().getString(R.string.str_test_item_hdcp1x), MtestConfig.TEST_RESULT_PASS);
        } else {
            pesiSharedPreference.putInt(getResources().getString(R.string.str_test_item_hdcp1x), MtestConfig.TEST_RESULT_FAIL);
        }
    ...
    private void startHDCPRunnable(){
        ...
        mHDCPRunnable = new Runnable() {
            public void run() {
                int ret = mHdcpModule.checkHdcp1x();
                Log.d(TAG, "run: checkHdcp1x ret = " + ret);
