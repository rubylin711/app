...
import com.prime.dtvplayer.TestData.sysglob.TpInfoFunc;
...
public class TestDataTpInfoFuncImpl implements TpInfoFunc {
    ...
    private void add(TpInfo pTp) {
        ...
        if(pTp.getTunerType() == TpInfo.DVBT || pTp.getTunerType() == TpInfo.ISDBT)
        {
        ...
        else if(pTp.getTunerType() == TpInfo.DVBC){
