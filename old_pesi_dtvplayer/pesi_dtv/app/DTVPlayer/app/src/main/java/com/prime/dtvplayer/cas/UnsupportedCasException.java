...
/**
 * Thrown when the requested CAS scheme is not supported.
 */
public final class UnsupportedCasException extends Exception {
  ...
  /**
   * The requested CAS scheme is unsupported by the device.
   */
  public static final int REASON_UNSUPPORTED_SCHEME = 1;
  /**
   * There device advertises support for the requested CAS scheme, but there was an error
   ...
   */
  public UnsupportedCasException(@Reason int reason) {
    this.reason = reason;
  }
   ...
   */
  public UnsupportedCasException(@Reason int reason, Exception cause) {
    super(cause);
    this.reason = reason;
  }
