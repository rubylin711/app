 ...
 */
public class PrimeHomeplusMemberCenterApplication extends Application
    ...
    // ---- Singleton / Globals ----
    private static PrimeHomeplusMemberCenterApplication sInstance;
...
//            Log.d("dtvService", "TVMessage.TYPE_SYSTEM_INIT callback "+ PrimeHomeplusMemberCenterApplication.class.getSimpleName());
    ...
    // ------------------------------------------------------------
    @MainThread
    public static PrimeHomeplusMemberCenterApplication getInstance() {
        return sInstance;
    }
