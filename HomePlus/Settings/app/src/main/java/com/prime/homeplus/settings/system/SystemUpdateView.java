...
public class SystemUpdateView extends ThirdLevelView {
    private String TAG = "HomePlus-SystemUpdateView";
    private SettingsRecyclerView settingsRecyclerView;
    private Context appContext;
    private TextView tvSoftwareVersion, tvMAC;

    public SystemUpdateView(int i, Context context, SettingsRecyclerView settingsRecyclerView) {
