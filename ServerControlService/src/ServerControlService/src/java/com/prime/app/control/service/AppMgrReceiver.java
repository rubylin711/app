...
public class AppMgrReceiver extends BroadcastReceiver
{
    ...
    public int      DEBUG_NORMAL            = ServerControlService.DEBUG_NORMAL;
    public int      DEBUG_VERBOSE           = ServerControlService.DEBUG_VERBOSE;
    public int      DEBUG                   = ServerControlService.DEBUG;
