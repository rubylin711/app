...
public class OtaReceiver extends BroadcastReceiver {
    ...
    int     DEBUG_NORMAL    = ServerControlService.DEBUG_NORMAL;
    int     DEBUG_VERBOSE   = ServerControlService.DEBUG_VERBOSE;
    int     DEBUG           = ServerControlService.DEBUG;
    int     mProgress       = 0;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (ABUPDATE_BROADCAST_ERROR.equals(action)) {
            ...
            sendMessage(MSG.BROADCAST_OTA_ERROR);
        }
        else
