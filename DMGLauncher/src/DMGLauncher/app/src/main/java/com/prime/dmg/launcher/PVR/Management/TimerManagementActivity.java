...
public class TimerManagementActivity extends BaseActivity implements PrimeDtv.DTVCallback {
    ...
    void delete_book_info() {
        ...
        if (timerListAdapter.delete_book_info()) {
            ...
            g_PrimeDtv.cancel_alarms(this, deleteBookInfo.get_Intent());
        }
    ...
    String get_record_info_string(BookInfo bookInfo) {
        ...
        return programInfo.getDisplayNum() + ". " + bookInfo.getEventName() + " " + bookInfo.get_book_cycle_string(this) + " "+ bookInfo.get_time_to_sting_format();
    }
