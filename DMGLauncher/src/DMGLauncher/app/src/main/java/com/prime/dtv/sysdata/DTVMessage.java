...
////////////////////////AV play/////////////////////////////
    ...
    public static final int PESI_SVR_EVT_AV_CALLBACK_END = 0x0001000E ;
    ...
    public static final int PESI_SVR_EVT_PVR_CALLBACK_END = 0x00050041;//Scoty 20180827 add and modify TimeShift Live Mode//eric lin 20180713 pvr msg,-end
    ...
    public static final int PESI_EVT_SYSTEM_CALLBACK_END = 0x000B000C;

    public static final int PESI_SVR_EVT_TBM_CALLBACK_START = 0x00BC0010 ;
    /**
     * Section table update message, param1 is TableType see PESI_SVR_TBM_TABLE_TYPE_E, param2 is sizeof TableType. <br>
     *
     */
    public static final int PESI_SVR_EVT_TBM_UPDATE = 0x00BC0010;
     ...
     *
     */
    public static final int PESI_SVR_EVT_TIME_UPDATE = 0x00BC0011;

    /**
     * TimeZone update message, param1 is s32TimeZoneSeconds, param2 is sizeof s32TimeZoneSeconds. <br>
     *
     */
    public static final int PESI_SVR_EVT_TIMEZONE_UPDATE = 0x00BC0012;
    public static final int PESI_SVR_EVT_TBM_CALLBACK_END = 0x00BC0013 ;
    ...
    public static final int PESI_EVT_CA_END = 0x000F0005;
