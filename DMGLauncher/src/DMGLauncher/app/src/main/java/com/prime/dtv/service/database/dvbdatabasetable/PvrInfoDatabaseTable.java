...
public class PvrInfoDatabaseTable {
    ...
    public static final int SeriesId = 1;
    public static final int IsSeries = 2;
    public static final int PlaybackTime = 3;
    ...
    public static String TableCreatePlayback() {
        ...
        cmd = "create table "
                + TABLE_NAME_PLAYBACK + " ("
                + MASTER_ID + " " + ColumnsPlaybackType[MasterId]+" primary key autoincrement,"
