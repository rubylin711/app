...
public class PrimeVolumeReceiver extends BroadcastReceiver {
    ...
    public static final String ACTION_KEYCODE_VOLUME_DOWN   = "com.prime.dmg.launcher.KEYCODE_VOLUME_DOWN";
    public static final String ACTION_KEYCODE_VOLUME_MUTE   = "com.prime.dmg.launcher.KEYCODE_VOLUME_MUTE";
    ...
    public static void init_volume(Context context) {
        new Thread(() -> {
            ...
            Log.d(TAG, "init_volume: volume = " + volume);

            AudioManager audioManager = context.getSystemService(AudioManager.class);
            boolean isMuted = audioManager.isStreamMute(AudioManager.STREAM_MUSIC);
            Log.d(TAG, "init_volume: isMuted = " + isMuted);
            if (isMuted)
