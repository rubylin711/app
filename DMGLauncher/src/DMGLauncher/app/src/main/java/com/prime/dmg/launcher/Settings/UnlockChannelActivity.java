...
public class UnlockChannelActivity extends FragmentActivity implements PrimeDtv.DTVCallback {
    private final static String TAG = "UnlockChannelActivity";

    public static final String ACTIVITY_UNLOCK_CHANNEL = "com.prime.dmg.launcher.Settings.UnlockChannelActivity";
    ...
    public static final String DEFAULT_WORKER_LOCK_PASSWORD = "77767776";
