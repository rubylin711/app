...
import static com.prime.dtv.service.datamanager.FavGroup.GROUP_ADULT;
import static com.prime.dtv.service.datamanager.FavGroup.GROUP_EDUCATION;
import static com.prime.dtv.service.datamanager.FavGroup.GROUP_KIDS;
import static com.prime.dtv.service.datamanager.FavGroup.GROUP_MOVIES;
import static com.prime.dtv.service.datamanager.FavGroup.GROUP_MUSIC;
import static com.prime.dtv.service.datamanager.FavGroup.GROUP_NEWS;
import static com.prime.dtv.service.datamanager.FavGroup.GROUP_RELIGION;
import static com.prime.dtv.service.datamanager.FavGroup.GROUP_SHOPPING;
import static com.prime.dtv.service.datamanager.FavGroup.GROUP_SPORTS;
import static com.prime.dtv.service.datamanager.FavGroup.GROUP_UHD;
import static com.prime.dtv.service.datamanager.FavGroup.GROUP_VARIETY;
...
import com.prime.dmg.launcher.Home.LiveTV.Zapping.ZappingDialog;
...
public class EpgActivity extends BaseActivity implements PrimeDtv.DTVCallback {
    private static final String TAG = "EpgActivity";
    public static final String CLS_EPG_ACTIVITY        = "com.prime.dmg.launcher.EPG.EpgActivity";
    ...
    public void on_record_started(TVMessage msg) {
        ...
        String channelNum = channel != null ? channel.getDisplayNum(MiniEPG.MAX_LENGTH_OF_CHANNEL_NUM) : "000";
    ...
    public void set_surface_view(){
        ...
        if(HomeApplication.get_prime_dtv().av_control_get_play_status(0) == AvCmdMiddle.PESI_SVR_AV_LIVEPLAY_STATE){
            ChannelChangeManager.setFCCVisible(AvCmdMiddle.getPlay_index());
        }
    }
    ...
    // Add function for scale tv view
    public void tv_view_scale(float scale) {
        if (g_surfaceView == null) return;
        ...
        Log.d(TAG, "tv_view_scale scale: " + scale + " w: " + newWidth + " h: " + newHeight);

        // Update SurfaceView 1
        androidx.constraintlayout.widget.ConstraintLayout.LayoutParams layoutParams = 
            (androidx.constraintlayout.widget.ConstraintLayout.LayoutParams) g_surfaceView.getLayoutParams();
        ...
        g_surfaceView.setLayoutParams(layoutParams);

        // Update SurfaceView 2
        if(g_surfaceView_2 != null) {
             androidx.constraintlayout.widget.ConstraintLayout.LayoutParams params2 = 
                (androidx.constraintlayout.widget.ConstraintLayout.LayoutParams) g_surfaceView_2.getLayoutParams();
             params2.width = newWidth;
             params2.height = newHeight;
             if (scale < 1.0f) {
                params2.verticalBias = 0.5f;
                params2.horizontalBias = 0.5f;
                params2.topToTop = androidx.constraintlayout.widget.ConstraintLayout.LayoutParams.PARENT_ID;
                params2.bottomToBottom = androidx.constraintlayout.widget.ConstraintLayout.LayoutParams.PARENT_ID;
                params2.startToStart = androidx.constraintlayout.widget.ConstraintLayout.LayoutParams.PARENT_ID;
                params2.endToEnd = androidx.constraintlayout.widget.ConstraintLayout.LayoutParams.PARENT_ID;
                params2.setMargins(0,0,0,0);
             }
             g_surfaceView_2.setLayoutParams(params2);
        }

        // Update SurfaceView 3
        if(g_surfaceView_3 != null) {
             androidx.constraintlayout.widget.ConstraintLayout.LayoutParams params3 = 
                (androidx.constraintlayout.widget.ConstraintLayout.LayoutParams) g_surfaceView_3.getLayoutParams();
             params3.width = newWidth;
             params3.height = newHeight;
             if (scale < 1.0f) {
                params3.verticalBias = 0.5f;
                params3.horizontalBias = 0.5f;
                params3.topToTop = androidx.constraintlayout.widget.ConstraintLayout.LayoutParams.PARENT_ID;
                params3.bottomToBottom = androidx.constraintlayout.widget.ConstraintLayout.LayoutParams.PARENT_ID;
                params3.startToStart = androidx.constraintlayout.widget.ConstraintLayout.LayoutParams.PARENT_ID;
                params3.endToEnd = androidx.constraintlayout.widget.ConstraintLayout.LayoutParams.PARENT_ID;
                params3.setMargins(0,0,0,0);
             }
             g_surfaceView_3.setLayoutParams(params3);
        }
    }
