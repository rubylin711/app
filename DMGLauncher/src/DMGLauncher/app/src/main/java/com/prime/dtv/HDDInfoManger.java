...
public class HDDInfoManger {
    ...
    private final PrimeDtv.DTVCallback callback; // 新增回調
    ...
    public HDDInfoManger(Context context,PrimeDtv.DTVCallback cb) {
        mContext = context;
    ...
    public void startMonitoring(long size_Mb) {
        ...
        long totalSize = Utils.get_usb_space_info().get(0);
        if (totalSize < 0) {
