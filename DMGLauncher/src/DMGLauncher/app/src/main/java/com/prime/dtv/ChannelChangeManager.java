...
import com.prime.dmg.launcher.Rank.RankActivity;
...
public class ChannelChangeManager implements PrimeDtv.DTVCallback {
    ...
    public static boolean isSetVisibleCompled = false;
...
//                return;
    ...
    public synchronized void change_channel_by_id(long target_ch_id, boolean force) {
        ...
        if(blockedChannel != null && !blockedChannel.isLock()) {
...
//        Log.d(TAG, "pvr_record_start: recordPath = " + recordPath);
        ...
        String chNum = programInfo != null ? programInfo.getDisplayNum(MiniEPG.MAX_LENGTH_OF_CHANNEL_NUM) : "000";
