...
import static com.prime.dmg.launcher.Settings.UnlockChannelActivity.PASSWORD_STAR;
...
//                LogUtils.d("g_tune_channel_runnable unlock channel change_channel_stop !!!!!!");
    ...
    private boolean check_channel_in_genre(int genre, ProgramInfo programInfo) {
        ...
        switch (genre) {
            ...
            case EpgActivity.TV_KID -> retValue = (programInfo.getCategory_type() & 0x0001) == 1;
            case EpgActivity.TV_EDUCATION -> retValue = ((programInfo.getCategory_type() & 0x0002) >> 1) == 1;
            case EpgActivity.TV_NEWS -> retValue = ((programInfo.getCategory_type() & 0x0004) >> 2) == 1;
            case EpgActivity.TV_MOVIE -> retValue = ((programInfo.getCategory_type() & 0x0008) >> 3) == 1;
            case EpgActivity.TV_VARIETY -> retValue = ((programInfo.getCategory_type() & 0x0010) >> 4) == 1;
            case EpgActivity.TV_MUSIC -> retValue = ((programInfo.getCategory_type() & 0x0020) >> 5) == 1;
            case EpgActivity.TV_ADULT -> retValue = ((programInfo.getCategory_type() & 0x0040) >> 6) == 1;
            case EpgActivity.TV_SPORT -> retValue = ((programInfo.getCategory_type() & 0x0080) >> 7) == 1;
            case EpgActivity.TV_RELIGION -> retValue = ((programInfo.getCategory_type() & 0x0200) >> 9) == 1;
            case EpgActivity.TV_UHD -> retValue = ((programInfo.getCategory_type() & 0x0800) >> 11) == 1;
            case EpgActivity.TV_SHOPPING -> retValue = ((programInfo.getCategory_type() & 0x80000) >> 19) == 1;
        }
