...
public class DMGSettingsFragment extends LeanbackSettingsFragmentCompat {
    ...
    public static final String ACTIVITY_CHANNEL_SCAN = "com.prime.dmg.launcher.Settings.ChannelScanningActivity";
    public static final String ACTIVITY_SPEED_TEST = "com.prime.dmg.launcher.Settings.TBCSpeedTestActivity";
    public static final String PACKAGE_LAUNCHER = "com.prime.dmg.launcher";
