...
public class ChannelScanningActivity extends BaseActivity implements PrimeDtv.DTVCallback {
    ...
    private static final int SCANNING_TIME_OUT = 30000;
    ...
    */
    ...
    public void onPause() {
        ...
        */
        ...
        if (this.g_restart_eit) {
            g_prime_dtv.start_schedule_eit();
        }
    ...
    private void scan_complete(TVMessage msg) {
        new Handler(Looper.getMainLooper()).postDelayed(() -> {
            ...
            g_prime_dtv.start_schedule_eit(); // start schedule EIT filter and send data to pesi c service
        }, 6000);
    }
...
//                    ChannelScanningActivity.this.onPause(); // this will cause onPause() trigger twice
    ...
    public void ready_to_scan(final int freq, final int sr, int bw, final int modulation, int tunerId) {
        ...
        this.g_handler.postDelayed(this.g_scan_timeout_runnable, 30000L);
