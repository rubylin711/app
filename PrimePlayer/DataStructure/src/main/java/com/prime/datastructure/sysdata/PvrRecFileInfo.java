...
public class PvrRecFileInfo {
    ...
    public static final int RECORD_STATUS_SUCCESS = 1;
    public static final int RECORD_STATUS_SUCCESS_INCOMPLETE = 2;
    ...
    private int mRecordStatus;          //0 means failure, 1 means success and complete, 2 means success but incomplete
    ...
    public PvrRecFileInfo(PvrDbRecordInfo pvrDbRecordInfo){
        ...
        mAdult = pvrDbRecordInfo.getAdult();
