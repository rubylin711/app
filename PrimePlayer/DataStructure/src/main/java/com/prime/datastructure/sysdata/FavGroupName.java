...
public class FavGroupName {
    ...
    public static final int TV_FAV_NUM = Pvcfg.TV_FAV_NO_MAX;//6;
    public static final int RADIO_FAV_NUM = Pvcfg.RADIO_FAV_NO_MAX;//2;
    public static final int GENRE_NUM = Pvcfg.GROUP_NO;
