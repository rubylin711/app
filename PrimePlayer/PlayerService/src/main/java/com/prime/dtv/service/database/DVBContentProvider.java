...
public class DVBContentProvider extends ContentProvider {
    ...
    public static final String LAUNCHER_AUTHORITY = DVBDatabase.LAUNCHER_AUTHORITY + ".DVBContentProvider";
    ...
    public static final int ITEM_CNS_MAIL = 11;
    public static final int ITEM_CNS_EAS = 12;
    ...
    static {
        ...
        URIMatcher.addURI(authority, CNSMailDatabaseTable.TABLE_NAME, ITEM_CNS_MAIL);
        URIMatcher.addURI(authority, CNSEasDatabaseTable.TABLE_NAME, ITEM_CNS_EAS);
    }

    private static DVBContentProvider mDVBContentProvider = null;

    public DVBContentProvider() {
        if(Pvcfg.isPrimeDTVServiceEnable())
    ...
    public DVBContentProvider(Context context) {
        if(Pvcfg.isPrimeDTVServiceEnable())
            mAuthority = AUTHORITY;
        else
            mAuthority = LAUNCHER_AUTHORITY;
    ...
    public static DVBContentProvider getDVBContentProvider(Context context) {
        if(mDVBContentProvider == null) {
            mDVBContentProvider = new DVBContentProvider(context);
        }
        return mDVBContentProvider;
    }
    ...
    private String GetTableName(Uri uri){
        switch(URIMatcher.match(uri)){
            ...
            case ITEM_CNS_MAIL:
                return CNSMailDatabaseTable.TABLE_NAME;
            case ITEM_CNS_EAS:
                return CNSEasDatabaseTable.TABLE_NAME;
            default:
...
//        getContext().getContentResolver().notifyChange(uri, null);
    ...
    public String getType(@NonNull Uri uri) {
        switch(URIMatcher.match(uri)){
            ...
            case ITEM_CNS_MAIL:
                return CNSMailDatabaseTable.CONTENT_TYPE;
            case ITEM_CNS_EAS:
                return CNSEasDatabaseTable.CONTENT_TYPE;
            default:
                throw new IllegalArgumentException("Unknown URI:" + uri);
        }
    }
