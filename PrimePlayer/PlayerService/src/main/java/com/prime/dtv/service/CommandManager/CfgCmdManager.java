    ...
    public void GposInfoUpdateByKeyString(String key,int value) {
        ...
        switch (key) {
            ...
            case GposInfo.GPOS_WORKER_PASSWORD_VALUE:
                ...
                break;
            case GposInfo.GPOS_PURCHASE_PASSWORD_VALUE:
                gposInfo.setPurchasePasswordValue(value);
                break;
            ...
            case GposInfo.GPOS_DVR_MANAGEMENT_LIMIT:
                ...
                break;
            case GposInfo.GPOS_TUTORIALSETTING:
                gposInfo.setTutorialSetting(value);
                break;
            case GposInfo.GPOS_STBDATA_RETURN:
                gposInfo.setSTBDataReturn(value);
                break;
            case GposInfo.GPOS_HDMI_CEC:
                gposInfo.setHdmiCecOnOff(value);
                break;
            case GposInfo.GPOS_RESOLUTION:
                gposInfo.setResolution(value);
            default:
                Log.d(TAG, "GposInfoUpdateByKeyString: [ERROR] save gpos member [" + key + "] not support !!");
                return;
        }
    ...
    public void GposInfoUpdateByKeyString(String key,long value) {
        ...
        switch (key) {
            case GposInfo.GPOS_CUR_CHANNELID:
                gposInfo.setCurChannelId(value);
                break;
            case GposInfo.GPOS_CAS_UPDATE_TIME:
                gposInfo.setCasUpdateTime(value);
                break;
            default:
                Log.d(TAG, "GposInfoUpdateByKeyString: [ERROR] save gpos member [" + key + "] not support !!");
        }
