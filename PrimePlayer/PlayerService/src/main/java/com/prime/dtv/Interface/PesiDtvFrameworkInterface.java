...
public abstract class PesiDtvFrameworkInterface {
    ...
    public abstract int StopDVBSubtitle();

    public abstract void setSurfaceView(Context context, SurfaceView surfaceView, int index);

    public abstract void setSurface(Surface surface,int index);
    ...
    public abstract void stopAllEitTableOnCurrentTp(int tuner_id);
...
//        Log.d(TAG, "add eventMapType to mListnerMap: (eventID= " + eventID + ")");
    ...
    public abstract void GposInfoUpdateByKeyString(String key,long value);
    ...
    public abstract ProgramInfo getProgramBySIdOnIDTsId(int sid, int onid, int tsid);
    ...
    public abstract void startScheduleEit(int tp_id,int tuner_id);
    ...
    public abstract void setLiveTvLayout(FrameLayout liveTvLayout);

    public abstract boolean isStartSubtitle();
    ...
    tuner hw
     */
    public abstract int init_tuner();
    ...
    public abstract int getFrequency(int nTunerID);
    ...
    public abstract int SetTvInputId(String id);
    public abstract String GetTvInputId();
    /*
    tp info
     */
    ...
    public abstract int AvControlResetAudioDefaultLanguage(String lang);
    /*
    PVR
     */
    //Start - Series Record
    ...
    public abstract long PvrRecordGetRecStartTimeByRecId(int recId);
    ...
    public abstract int PvrGetPlaybackRecCount();
    ...
    public abstract boolean PvrCheckSeriesComplete(byte[]  seriesKey);
    public abstract boolean PvrIsIdxInUse(PvrRecIdx pvrRecIdx);
    public abstract int PvrModifyPlayStopPos(PvrRecIdx pvrRecIdx, int position);
    // End - Series Record
    ...
    */
    ...
    public abstract void delete_maildata_of_db(int mail_id);
    public abstract void save_maildata_to_db(MailData mailData);
    public abstract MailData get_mail_from_db(int id);
    public abstract List<MailData> get_mail_list_from_db();
    public abstract List<FavGroup> fav_group_get_list();

    public abstract void setSetVisibleCompleted(boolean isVisibleCompleted);

    public abstract void set_cns_ota();

    public abstract String ota_get_update_info();
    public abstract String ota_upload_first_boot_info();
    public abstract String ota_boot_login();
    public abstract String ota_upload_update_status();

    public abstract int start_ota_update();
}
