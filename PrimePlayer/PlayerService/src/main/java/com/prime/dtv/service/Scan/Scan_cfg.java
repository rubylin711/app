...
public class Scan_cfg {
    ...
    public static final int FM_RADIO_SERVICE = 0x07;
    ...
    public static final int ISDBT_ONESEG_SERVICE = 0xC0;
    public static final int HEVC = 0x1f;
    public static final int HEVC_UHD = 0x20;
    ...
    public static final int SUNTV_NEtWORK_ID = 0x12;
    public static final int SUNTV_BOUQUET_ID = 0x3E8;
    public static final int SUNTV_CA_BOUQUET_ID = 0x3622;
