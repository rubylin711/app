...
//        return mTunerInterface.tune(tvTunerParams.getTunerId(), tvTunerParams) ? 0 : -1;
    ...
    public int getFrequency(int nTunerID) {
        return mTunerInterface.getFrequency(nTunerID);
    }
    ...
    public void BaseHandleMessage(Message msg) {
        switch(msg.what) {
            case MSG_TUNE:
                ...
                if(dataManager.getTpInfo(tvTunerParams.getTpId()).getTunerType() == TpInfo.DVBS)
                    mTunerInterface.tune(tvTunerParams.getTunerId(),dataManager.getTpInfo(tvTunerParams.getTpId()), dataManager.getSatInfo(tvTunerParams.getSatId()));
                else
