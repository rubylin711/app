package com.prime.dtv.service.database.netstreamdatabasetable;
...
public class NetProgramDatabaseTable {
    ...
    public NetProgramDatabaseTable(Context context) {
        mContext = context;
        CONTENT_URI = Uri.parse("content://" + DVBContentProvider.getDVBContentProvider(null).getAuthority() + "/" + TABLE_NAME);
    }
...
//    }
    ...
    private NetProgramInfo ParseCursor(Cursor cursor){
        ...
        netprogramInfo.setChannelId(mDbUtils.GetLongFromTable(TABLE_NAME,cursor, NetProgramInfo.CHANNEL_ID));
        netprogramInfo.setPlayStreamType(mDbUtils.GetIntFromTable(TABLE_NAME,cursor, NetProgramInfo.PLAY_STREAM_TYPE));
        netprogramInfo.setGroupType(mDbUtils.GetIntFromTable(TABLE_NAME,cursor, NetProgramInfo.GROUP_TYPE));
        netprogramInfo.setChannelNum(mDbUtils.GetIntFromTable(TABLE_NAME,cursor, NetProgramInfo.DISPLAY_NUM));
        netprogramInfo.setChannelName(mDbUtils.GetStringFromTable(TABLE_NAME,cursor, NetProgramInfo.DISPLAY_NAME));
        netprogramInfo.setUserLock(mDbUtils.GetIntFromTable(TABLE_NAME,cursor, NetProgramInfo.LOCK));
        netprogramInfo.setSkip(mDbUtils.GetIntFromTable(TABLE_NAME,cursor, NetProgramInfo.SKIP));
        netprogramInfo.setVideoUrl(mDbUtils.GetStringFromTable(TABLE_NAME,cursor, NetProgramInfo.VIDEO_URL));
        Log.i(TAG, "TestDataBase mDbUtils.GetIntFromTable(cursor, _ID) = "+mDbUtils.GetIntFromTable(TABLE_NAME,cursor, "_ID") +
                " channel id = ["+netprogramInfo.getChannelId() +"] VideoUrl =[" + netprogramInfo.getVideoUrl()+"]\n origin = [" + mDbUtils.GetStringFromTable(TABLE_NAME,cursor, NetProgramInfo.VIDEO_URL) +"]");
        return netprogramInfo;
    }
}