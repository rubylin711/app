...
public class DVBString {
    ...
    public final String DEFAULT_DVB_STRING_ENCODE = "(ISO 6937, latin)";
    ...
    public String toString(Charset defaultCharSet) {
        //Log.d(TAG,"aaaaa getCharSet() = "+getCharSet()+ " defaultCharSet = "+defaultCharSet +
        //        " getEncodingString = "+getEncodingString());
        if((getCharSet()!=null) || (defaultCharSet == null) || (getEncodingString() == DEFAULT_DVB_STRING_ENCODE)){
            Log.d(TAG,"return toString = "+toString());
            return toString();
        }
//        Log.d(TAG,"getEncodingString = "+getEncodingString());
        String str = new String(data, this.getOffset() + 1, this.getLength(), defaultCharSet);
//        Log.d(TAG,"return new String = "+str);
        return str;
    }
    ...
    public String getEncodingString(){
        ...
        //Log.d(TAG,"getEncodingString fb = "+Integer.toHexString(fb) );
        if(0x20<=fb)
        {
            return "UTF-8";
