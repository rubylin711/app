...
import static com.prime.dtv.service.Util.HttpURLConnectionUtil.hexStringToByteArray;
...
public class CryptoUtils {
    ...
    private static final String cnskeyHex = "b0db45e851736933a26887e5ac2a8748";
    private static final String cnsivHex = "fc0189c13438348b65b03002a74ce7ad";
    private static final String cnsPublicKeyStr= "MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAEILWPp6PwXoetcEDMDWpBktLLH0WPT7mr64Xb6Fmer0DPb+64HG4rs51OTDjhU835xQRLA5kh1n9XJz3kyyt9yw==";
    ...
    public byte[] getKeyHex() {
        return hexStringToByteArray(cnskeyHex);
    }

    public byte[] getIvHex() {
        return hexStringToByteArray(cnsivHex);
    }

    public String getPublicKeyStr() {
        return cnsPublicKeyStr;
    }

    // (1) Verify ECDSA signature
    public boolean verifyECDSASignature(byte[] message, byte[] signature) {
        try {
            byte[] publicKeyBytes = Base64.getDecoder().decode(getPublicKeyStr());
    ...
    public byte[] encryptAES(byte[] data) {
        try {
            ...
            SecretKeySpec secretKeySpec = new SecretKeySpec(getKeyHex(), "AES");
            IvParameterSpec ivParameterSpec = new IvParameterSpec(getIvHex());
