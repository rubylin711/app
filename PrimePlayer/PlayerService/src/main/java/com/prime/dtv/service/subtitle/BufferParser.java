...
public class BufferParser {
    ...
    public static final String TAG = "BufferParser";
    ...
    public long readLong(int nbBits, String description) {
        ...
        if (mPosInBits + nbBits > mLength * 8) {
            Exception e = new IllegalArgumentException(String.format(Locale.US, "Out of bounds (pos=%d, nbBits=%d, length=%d) field='%s'",
