...
import com.prime.primetvinputapp.ChannelChangeManager;
import com.prime.primetvinputapp.PrimeTvInputAppApplication;
import com.prime.primetvinputapp.R;
import com.prime.primetvinputapp.Scan.ChannelScanView;
import com.prime.primetvinputapp.Scan.SignalDetectView;
...
public class ChannelScanningActivity extends BaseActivity implements PrimeDtvInterface.DTVCallback {
    ...
    private static final int SCANNING_TIME_OUT = 60*1000;
    ...
    private PrimeDtvServiceInterface g_prime_dtv;
...
//            ChannelScanningActivity.this.g_handler.postDelayed(this, 500L);
    ...
    */
    ...
    protected void onResume() {
        super.onResume();
        g_prime_dtv = PrimeTvInputAppApplication.get_prime_dtv_service();
        ...
        if (msg.getMsgFlag() == TVMessage.FLAG_SCAN) {
            switch (msg.getMsgType()) {
                ...
                case TVMessage.TYPE_SCAN_END:
                    ...
                    boolean isLock = g_prime_dtv.get_tuner_status(g_tuner_id);
...
//                    ChannelScanningActivity.this.onPause(); // this will cause onPause() trigger twice
        ...
        g_prime_dtv = PrimeTvInputAppApplication.get_prime_dtv_service();
        g_ch_change_manager = ChannelChangeManager.get_instance(this);
...
//            g_do_signal_detect_flag = acs_data != null && acs_data.equals("1");
    ...
    public void start_scan(final int freq, final int sr, int bw, final int modulation, int tunerId, boolean isSingleFreq) {
        TpInfo tpInfo1 = g_prime_dtv.tp_info_get(0);
        List<TpInfo> tpList =
        ...
        Log.d("PrimeDtvService","start_scan tpList[0] = "+tpList.get(0).ToString());
        TpInfo tpInfo = null;
...
//        Log.d(TAG, "update_signal_value: ber = " + ber);
    ...
    private void add_music_category_to_fav() {
        Log.d(TAG,"add_music_category_to_fav()");
        ...
        Log.d(TAG, "add_music_category_to_fav: programInfoList size = " + programInfoList.size());
