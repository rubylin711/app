...
import com.prime.launcher.Home.LiveTV.Music.Vumeterlibrary.VuMeterView;
...
public class MusicView extends RelativeLayout {
    ...
    public List<MusicInfo> get_music_category_list() {
        g_category_info_list = get_prime_dtv().get_current_category(get_context());
    ...
    public void category_update_to_fav(Context context) {
        ...
        get_context().g_dtv.category_update_to_fav(musicInfoList, g_category_info_list);
    }

    public void clear_category_to_fav() {
        Log.d(TAG, "clear_category_to_fav: ");
        List<FavGroup> favGroupList = get_context().g_dtv.fav_group_get_list();
    ...
    public void update_music_ad() {
        g_music_ad_info_list = MusicAdScheduleInfo.get_music_ad_info_list_from_schedule(get_prime_dtv().get_music_ad_schedule_info_list(get_context()));
    }
