...
import com.prime.launcher.Settings.DMGSettingsActivity;
...
public class HomeApplication extends Application {
    ...
    public static final String DVBContentProviderAUTHORITY = "com.prime.launcher.database.DVBContentProvider";
    public static final String PVRContentProviderAUTHORITY = "com.prime.launcher.database.PVRContentProvider";
    ...
    public void onCreate() {
        super.onCreate();
        g_dtv = new PrimeDtv(new PrimeDtv.LauncherCallback() {
            @Override
...
//        g_dtv.register_callbacks();
        ...
        g_dtv.setACSMusicList(this);

        Log.e(TAG,"this function not porting!! please check end");
    ...
    private static SurfaceView cachedOverlayView;

    public static void cacheOverlayView(SurfaceView view) {
        cachedOverlayView = view;
    }

    public static SurfaceView getCachedOverlayView() {
        return cachedOverlayView;
    }
}
