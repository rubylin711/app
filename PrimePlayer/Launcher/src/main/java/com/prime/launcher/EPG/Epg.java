...
public class Epg{
    ...
    public void cancel_timer(Context context, BookInfo bookInfo) {
        ...
        cancel_alarms(context, g_dtv.get_book_info_intent(bookInfo));
    }
    ...
    public static String get_channel_full_name(ProgramInfo channel) {
        if (channel == null)
            return "NULL";
        return channel.getDisplayNum(com.prime.datastructure.utils.Utils.MAX_LENGTH_OF_CHANNEL_NUM) + " " + channel.getDisplayName();
    }
}
