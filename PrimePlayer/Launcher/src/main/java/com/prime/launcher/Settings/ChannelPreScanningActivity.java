...
import com.prime.launcher.Settings.fragment.SelectQamFragment;
...
public class ChannelPreScanningActivity extends BaseActivity {
    ...
    public final static String DEFAULT_CNS_CHANNEL_FREQUENCY = "405";
    public final static String DEFAULT_CNS_CHANNEL_SYMBOL_RATE = "5217";
    public final static String DEFAULT_CNS_CHANNEL_QAM_TEXT = "256";
    ...
    private void init() {
        ...
        if (tpInfo != null) {
            ...
            if(ACSHelper.get_ProjectId(this) == ACSHelper.PROJECT_TBC) {
                ...
                g_textv_frequency.setText(DEFAULT_CNS_CHANNEL_FREQUENCY);
                g_textv_symbolrate.setText(DEFAULT_CNS_CHANNEL_SYMBOL_RATE);
                g_textv_qam.setText(DEFAULT_CNS_CHANNEL_QAM_TEXT);
                LogUtils.d("CNS ");
            }
            else {
    ...
    private void add_music_category_to_fav() {
        ...
        get_prime_dtv().category_update_to_fav(programInfoList,musicInfoList);
    }
}
