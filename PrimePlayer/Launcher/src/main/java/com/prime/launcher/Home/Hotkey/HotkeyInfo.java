...
import com.prime.launcher.EPG.Epg;
...
public class HotkeyInfo extends BaseDialog {
    ...
    public void show_detail_present(EPGEvent epgEvent, boolean isRadio) {
        ...
        g_chNum     = channel == null ? "000"       : channel.getDisplayNum(com.prime.datastructure.utils.Utils.MAX_LENGTH_OF_CHANNEL_NUM);
    ...
    public void show(Epg epg, ProgramInfo channelInfo, EPGEvent epgEvent) {
        ...
        MiniEPG.update_timezone_offset();
        g_chNum         = channelInfo == null ? "000"       : channelInfo.getDisplayNum(com.prime.datastructure.utils.Utils.MAX_LENGTH_OF_CHANNEL_NUM);
