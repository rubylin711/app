...
import static com.prime.launcher.Home.Hotkey.HotkeyInfo.Detail;
...
//    public static final int MAX_LENGTH_OF_CHANNEL_NUM   = 3; //move to com.prime.datastructure.utils
//    public static final int MAX_LENGTH_OF_SERVICE_ID    = 3; //move to com.prime.datastructure.utils
    ...
    private String get_booking_name(BookInfo bookInfo) {
        ...
        return "[" + channel.getDisplayNum(com.prime.datastructure.utils.Utils.MAX_LENGTH_OF_CHANNEL_NUM) + "] " + bookInfo.getEventName();
    }
    ...
    public void set_channel_num(ProgramInfo chInfo) {
        ...
        chNumView.setText(chInfo.getDisplayNum(com.prime.datastructure.utils.Utils.MAX_LENGTH_OF_CHANNEL_NUM));
    }
    ...
    public void set_channel_icon(ProgramInfo chInfo) {
        ...
        iconExecutor.execute(() -> {
            ...
            String serviceId = chInfo.getServiceId(com.prime.datastructure.utils.Utils.MAX_LENGTH_OF_SERVICE_ID);
    ...
    public void do_channel_icon_preload() {
        ...
        prevIconUrl = LiveTvManager.get_channel_icon_url(get(), prevInfo.getServiceId(com.prime.datastructure.utils.Utils.MAX_LENGTH_OF_SERVICE_ID));
        currIconUrl = LiveTvManager.get_channel_icon_url(get(), currInfo.getServiceId(com.prime.datastructure.utils.Utils.MAX_LENGTH_OF_SERVICE_ID));
        nextIconUrl = LiveTvManager.get_channel_icon_url(get(), nextInfo.getServiceId(com.prime.datastructure.utils.Utils.MAX_LENGTH_OF_SERVICE_ID));
        ...
        get().runOnUiThread(() -> {
            ...
            for (RecChannelInfo recInfo : recInfoList) {
                ...
                if (changeManager.is_last_recording(channelId))
                    continue;
                String channelNum = liveTvManager.get_channel(channelId).getDisplayNum(com.prime.datastructure.utils.Utils.MAX_LENGTH_OF_CHANNEL_NUM);
    ...
    public void show_info() {
        ...
        if (get().get_channel_change_manager().is_timeshift_start()) {
    ...
    private BookInfo build_book_info(ProgramInfo channel, EPGEvent event) {
        ...
        bookInfo.setChannelNum(channel.getDisplayNum(com.prime.datastructure.utils.Utils.MAX_LENGTH_OF_CHANNEL_NUM));
