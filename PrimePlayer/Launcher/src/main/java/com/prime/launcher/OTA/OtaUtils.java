...
import com.prime.launcher.Settings.fragment.EngineeringSettingFragment;
...
public class OtaUtils {
    ...
    public static final String START_OTA_REMINDER_ACTION = "com.prime.launcher.OTA.reminder.reach" ;
    ...
    private static @NonNull Intent get_ota_intent( OtaParam otaParam ) {
        ...
        if (SystemProperties.get(OTA_MODE).equals("download")) {
            ...
            intent.putExtra(EngineeringSettingFragment.EXTRA_CALLER, "com.prime.launcher");
