...
public class FavListAdapter extends RecyclerView.Adapter<FavListAdapter.Holder> {
    ...
    public class Holder extends RecyclerView.ViewHolder {
        ...
        public void init_channel_item(int pos) {
            ...
            chNum.setText(favChannel.getDisplayNum(com.prime.datastructure.utils.Utils.MAX_LENGTH_OF_CHANNEL_NUM));
        ...
        public void init_channel_icon(ProgramInfo favChannel) {
            ...
            serviceId   = favChannel.getServiceId(com.prime.datastructure.utils.Utils.MAX_LENGTH_OF_SERVICE_ID);
